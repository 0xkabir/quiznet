...
const Quiz = () => {
    ...
    return (
        <ResultContext.Provider value={testResult}>
            <div>
            <div className='pt-10'>
            ...
            <div className='text-center'>
                <button className='bg-slate-800 hover:bg-slate-900 text-white font-medium mt-5 mb-10 px-5 py-2 rounded-lg' disabled={givenAnswer!==total?true:false} onClick={()=>setShowResultModal(true)}>Finish Quiz</button>
            </div>
